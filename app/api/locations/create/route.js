...
export async function POST(request) {
  ...
  const { data, error } = await service
    ...
    .insert({
      ...
      doelgroep: Array.isArray(body.doelgroep) && body.doelgroep.length ? body.doelgroep : null,
      leeftijdsgroep: Array.isArray(body.leeftijdsgroep) && body.leeftijdsgroep.length ? body.leeftijdsgroep : null,
