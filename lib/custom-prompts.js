...
export const CUSTOM_PROMPTS = {
  'meeting-summary': (text) =>
    `GENEREER DIRECT: Maak het document nu volledig op basis van de beschikbare input. Stel geen vragen. Vraag nooit om meer informatie. Wat ontbreekt krijgt een markering zoals [UITZOEKEN INTERN] of [AFSTEMMEN MET KLANT].
...
${text}`,
  ...
  'evaluation': (text) =>
    `GENEREER DIRECT: Maak het document nu volledig op basis van de beschikbare input. Stel geen vragen. Vraag nooit om meer informatie. Wat ontbreekt krijgt een markering zoals [CIJFERS TOEVOEGEN] of [NOG NIET CONCREET GENOEG].
...
${text}`,
  ...
  'account-to-pm': (text) =>
    `GENEREER DIRECT: Maak het document nu volledig op basis van de beschikbare input. Stel geen vragen. Vraag nooit om meer informatie. Genereer altijd op basis van wat beschikbaar is. Wat ontbreekt krijgt een markering zoals [UITZOEKEN INTERN] of [AFSTEMMEN MET KLANT]. Weiger nooit te genereren.
...
${text}`,
  ...
  'external-debrief': (text) =>
    `GENEREER DIRECT: Maak het document nu volledig op basis van de beschikbare input. Stel geen vragen. Vraag nooit om meer informatie. Genereer altijd op basis van wat beschikbaar is. Wat ontbreekt krijgt een markering zoals [CIJFERS TOEVOEGEN] of [AFSTEMMEN MET KLANT]. Weiger nooit te genereren.
...
Heb je een specifieke leveranciersvraag? Stel hem dan als vrije vraag in de chat.`,
  ...
  'account-to-creation': (text) =>
    `GENEREER DIRECT: Maak het document nu volledig op basis van de beschikbare input. Stel geen vragen. Vraag nooit om meer informatie. Wat ontbreekt krijgt een markering zoals [AFSTEMMEN MET KLANT] of [UITZOEKEN INTERN].
...
${text}`,
  ...
  'field-briefing': (text) =>
    `GENEREER DIRECT: Maak het document nu volledig op basis van de beschikbare input. Stel geen vragen. Vraag nooit om meer informatie. Wat ontbreekt krijgt een markering zoals [UITZOEKEN INTERN] of [AFSTEMMEN MET OPDRACHTGEVER].
...
export const OUTPUT_TYPE_INFO = {
  ...
  // Chase-specifieke types
  'account-to-pm':        { label: 'PM Overdracht',       icon: 'pen-line' },
  'field-briefing':       { label: 'Veldbriefing',        icon: 'clipboard' },
  'external-debrief':     { label: 'Externe Debrief',     icon: 'send' },
  'account-to-creation':  { label: 'Creatieve Briefing',  icon: 'paintbrush' },
};
