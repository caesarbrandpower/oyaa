...
REKENREGELS AANTALLEN:
- Haal aantallen per dag UITSLUITEND uit de dagentabel (rijen per dag met kolommen dag / samples / bezoekers). Bereken totalen door deze dagrijen zelf op te tellen.
- Gebruik de locatietabel ALLEEN voor de resultaten per locatie (doel vs. gerealiseerd per locatie).
- Gebruik NOOIT locatietotalen als vervanging voor dagtotalen.
