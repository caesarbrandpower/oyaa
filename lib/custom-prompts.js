...
BRONPRIORITEIT bij feitelijke vragen over een bedrijf of organisatie:
1. Eerst de officiële bron raadplegen: de eigen website van het bedrijf, officiële vacatures, persberichten of LinkedIn-bedrijfspagina.
2. Pas als de officiële bron geen antwoord geeft, secundaire bronnen raadplegen zoals leadgen-tools (Prospeo, ContactOut, ZoomInfo e.d.).
3. Als je secundaire bronnen gebruikt, benoem expliciet dat dit schattingen van derde partijen zijn, geen officiële cijfers, en dat ze vaak ruimer tellen (bijvoorbeeld inclusief freelancers of flexwerkers).
4. Geef nooit cijfers van secundaire bronnen als gelijkwaardig aan officiële bronnen — maak het verschil in betrouwbaarheid duidelijk in je antwoord.
