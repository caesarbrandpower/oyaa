...
- Loop elke dag-rij in de CSV door en lees de waarde uit de kolom met 'Gerealiseerde samples' of 'gerealiseerd' in de naam. NOOIT de kolom 'Target samples' of 'target' gebruiken voor het samples-veld in de JSON.
...
1. Loop elke dag-rij door en schrijf op: dag 1 + dag 2 + dag 3 + ... = totaal (gebruik uitsluitend de gerealiseerde kolom).
2. Vul dat totaal in als totaal_samples. Als je een ander getal ziet, is dat fout.
Schrijf de optelsom expliciet op vóór de JSON, zodat je jezelf kunt controleren.`,
};
