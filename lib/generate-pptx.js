...
export async function buildPresentation(data) {
  ...
  // SLIDE 1 — TITELSLIDE
  {
    ...
    s.addText([
      ...
      fontSize: 15, fontFace: 'Tungsten Book', align: 'left', margin: 0,
    });
  ...
  // SLIDE 2 — KERNRESULTATEN
  {
    ...
    cards.forEach((card, i) => {
      ...
      s.addText(card.value, {
        ...
        fontFace: 'Tungsten Book', align: 'center', valign: 'middle', margin: 0,
      });
      s.addText(card.sub, {
  ...
  // SLIDE 3 — AANTALLEN PER DAG
  {
    ...
    s.addTable(tabelRows, {
      ...
      fontSize: 12, fontFace: 'Tungsten Book', rowH: 0.46,
    });
    addLogo(s);
    addPageNum(s, 3);
  }
  ...
  // SLIDE 5 — VERLOOP VAN DE ACTIE
  {
    ...
    data.verloop.forEach((item, i) => {
      ...
      s.addText(item.tekst, {
        ...
        fontSize: 10, color: C.darkgrey, fontFace: 'Arial',
        valign: 'top', margin: 0,
      });
    });
    addLogo(s);
  ...
  // SLIDE 7 — ACTIEPUNTEN
  {
    ...
    s.addText('Volgende editie', {
      ...
      fontSize: 14, bold: false, color: C.greyblue, fontFace: 'Tungsten Book', margin: 0,
    });
  ...
  // SLIDE 8 — EINDSLIDE
  {
    ...
    s.addImage({ path: LOGO_DIAP, x: 8.82, y: 5.08, w: 1.06, h: 0.44,
      sizing: { type: 'contain', w: 1.06, h: 0.44 } });
    addPageNum(s, 8);
  }
