...
export async function buildPresentation(data) {
  ...
  // SLIDE 1 — TITELSLIDE
  {
    ...
    if (data.foto_product) {
      ...
      s.addText('[ PRODUCTFOTO ]', {
        x: 5.5, y: 0, w: 4.5, h: 5.625,
        fontSize: 11, color: '3A4090', fontFace: 'Arial',
        align: 'center', valign: 'middle', margin: 0,
      });
    }
    ...
    s.addText([
      ...
      fontSize: 14, fontFace: 'Arial', align: 'left', margin: 0,
    });
    ...
    s.addText('Gegenereerd via Waybetter', {
      ...
      fontSize: 8, color: '3A4090', fontFace: 'Arial', margin: 0,
    });
    addPageNum(s, 1);
  }
  ...
  // SLIDE 2 — KERNRESULTATEN
  {
    ...
    s.addText(`${data.dagen.length} dagen  ·  ${data.locaties.length} locaties  ·  ${data.periode}`, {
      ...
      fontSize: 12, color: C.darkgrey, fontFace: 'Arial', margin: 0,
    });
    addLogo(s);
    addPageNum(s, 2);
  }
  ...
  // SLIDE 3 — AANTALLEN PER DAG
  {
    ...
    s.addTable(tabelRows, {
      ...
      fontSize: 11, fontFace: 'Arial', rowH: 0.46,
    });
    addLogo(s);
    addPageNum(s, 3);
  }
  ...
  // SLIDE 4 — RESULTATEN PER LOCATIE
  {
    ...
    s.addTable(rows, {
      ...
      fontSize: 12, fontFace: 'Arial', rowH: 0.48,
    });
    s.addChart(pres.charts.BAR, [
  ...
  // SLIDE 5 — VERLOOP VAN DE ACTIE
  {
    ...
    data.verloop.forEach((item, i) => {
      ...
      s.addText(item.tekst, {
        ...
        fontSize: 11, color: C.darkgrey, fontFace: 'Arial',
        valign: 'top', margin: 0,
      });
    });
  ...
  // SLIDE 6 — TERUGBLIK
  {
    ...
    cols.forEach((col, i) => {
      ...
      s.addText(items, {
        ...
        fontSize: 13, fontFace: 'Arial', valign: 'top',
  ...
  // SLIDE 7 — ACTIEPUNTEN
  {
    ...
    s.addText('VOLGENDE EDITIE', {
      ...
      fontSize: 13, color: C.greyblue, fontFace: 'Arial', margin: 0,
    });
    data.actiepunten.forEach((actie, i) => {
      ...
      s.addText(actie, {
        ...
        fontSize: 13, color: C.navy, fontFace: 'Arial', valign: 'middle', margin: 0,
      });
    });
    s.addShape(pres.shapes.ROUNDED_RECTANGLE, {
  ...
  // SLIDE 8 — EINDSLIDE
  {
    ...
    if (data.foto_actie2) {
      ...
      s.addText('[ ACTIEFOTO ]', {
        x: 0.5, y: 0, w: 9.5, h: 5.625,
        fontSize: 13, color: '3A4090', fontFace: 'Arial',
        align: 'center', valign: 'middle', margin: 0,
      });
    }
    s.addText(data.campagne.toUpperCase(), {
