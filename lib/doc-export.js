...
export function buildFilename(outputType, client, project, extension) {
  ...
  // Client en project samengevoegd met spatie: "Briefing PM - Coca-Cola Lenteactie 26"
  const cpPart = [client, project].filter(Boolean).map(sanitizePart).filter(Boolean).join(' ');
