...
Regels voor ontbrekende informatie:
- Als info bij de klant ligt: schrijf "🔴 AFSTEMMEN MET KLANT - [concrete vraag die je moet stellen]"
- Als info intern bepaald moet worden: schrijf "🔴 UITZOEKEN INTERN - [concrete actie]"
- Als info deels besproken maar niet concreet: schrijf "🟡 NOG NIET CONCREET GENOEG - [wat moet scherper]"
...
Regels voor ontbrekende informatie:
- Als info alleen de klant kan geven: schrijf "🔴 AFSTEMMEN MET KLANT - [concrete vraag die je moet stellen]"
- Als info intern bepaald moet worden: schrijf "🔴 UITZOEKEN INTERN - [concrete actie]"
- Als info bij een externe partij ligt: schrijf "🔴 NAVRAGEN BIJ [naam leverancier of 'leverancier'] - [concrete vraag]"
- Als info deels besproken maar niet concreet: schrijf "🟡 NOG NIET CONCREET GENOEG - [wat moet scherper]"
- Als een actiepunt geen uitvoerder heeft: schrijf "🟡 WIE GAAT DIT DOEN?"
- Als een actiepunt geen datum heeft: schrijf "🟡 WANNEER MOET DIT KLAAR ZIJN?"
...
Regels voor ontbrekende informatie:
- Als resultaatcijfers ontbreken: schrijf "🔴 CIJFERS TOEVOEGEN - [welke data moeten aangevuld worden]"
- Als achtergrond ontbreekt: schrijf "🔴 ACHTERGROND TOEVOEGEN - [wat ontbreekt]"
- Als info deels besproken maar niet concreet: schrijf "🟡 NOG NIET CONCREET GENOEG - [wat moet scherper]"
