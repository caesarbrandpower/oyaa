...
export const THEMES = {
  ...
  'coca-cola': {
    colors: {
      navy:     'CC0000',   // TIJDELIJK rood voor zichtbare test — vervang door echte kleur
      accent:   'FFFFFF',   // TIJDELIJK wit accent — vervang door echte kleur
      greyblue: '9BAFBC',
      lightbg:  'FFEEEE',   // TIJDELIJK lichtroze achtergrond — vervang door echte kleur
      white:    'FFFFFF',
      darkgrey: '444444',
    },
    logos: {
